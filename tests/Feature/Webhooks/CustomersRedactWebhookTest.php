...
mutates(CustomersRedactWebhook::class);

describe('POST /webhook/customers-redact', function (): void {
    beforeEach(function (): void {
        config(['shopify-app.api_secret' => 'test-shopify-secret']);

        $this->shopDomain = 'customers-redact-shop.myshopify.com';
    ...
    it('returns 200 for a request with a valid HMAC signature and shop domain header', function (): void {
        ...
        $response = $this->postJson('/webhook/customers-redact', $this->payload, [
